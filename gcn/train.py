...
from gcn.models import GCN, MLP, MAGE
...
placeholders = {
    ...
    'motif_support': [tf.sparse_placeholder(tf.float32) for _ in range(num_supports)],
...
def evaluate(features, support, labels, mask, placeholders):
    t_test = time.time()
    feed_dict_val = construct_feed_dict(features, support, labels, mask, placeholders, support_m)
